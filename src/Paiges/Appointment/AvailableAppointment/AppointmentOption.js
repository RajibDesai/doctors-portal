        ...
        <div className="card shadow-xl">
            <div className="card-body text-center">
                ...
                <div className="card-actions justify-center">
                    <button className="btn btn-primary text-white" onClick={() => {document.getElementById('booking-modal').showModal(); setTreatement(appointmentOption)}}>Book Appointment</button>
                </div>
            </div>
        </div>
    );
